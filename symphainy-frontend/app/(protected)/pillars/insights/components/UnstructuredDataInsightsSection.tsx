/**
 * UnstructuredDataInsightsSection Component
 * 
 * Complete section for unstructured data insights analysis
 * Includes file/metadata selection, AAR mode toggle, analysis trigger, and results display
 */
...
export function UnstructuredDataInsightsSection({ 
  onAnalysisComplete 
}: UnstructuredDataInsightsSectionProps) {
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-600 mt-1">
              Enable specialized analysis for after-action reports including lessons learned, risk assessment, recommendations, and timeline extraction
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          {loading ? 'Analyzing...' : aarMode ? 'Analyze AAR' : 'Analyze Content'}
        </Button>
      ...
      {/* AAR Analysis Section (if AAR mode was used and results exist) */}
      {analysisResult?.aar_analysis && !loading && (
        <AARAnalysisSection
          aarAnalysis={analysisResult.aar_analysis}
