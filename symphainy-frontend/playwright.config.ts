...
export default defineConfig({
  ...
  /* Global test timeout */
  timeout: 60000, // Increased for full journey tests

  /* Expect timeout */
  expect: {
    timeout: 10000, // Increased for complex interactions
  },
  ...
  /* Test metadata */
  metadata: {
    name: 'Symphainy MVP 4-Pillar Journey E2E Tests',
    version: '1.0.0',
    description: 'End-to-end tests for Symphainy MVP 4-pillar journey',
  },
