...
class EnvironmentLoader:
    ...
    def get_database_config(self) -> Dict[str, Any]:
        ...
        return {
            "url": self.config_manager.get("DATABASE_URL"),
    ...
    def get_security_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "jwt_secret": self.config_manager.get("JWT_SECRET"),
            "jwt_algorithm": self.config_manager.get("JWT_ALGORITHM", "HS256"),
            "jwt_expiration": self.config_manager.get_int("JWT_EXPIRATION", 3600)
        }
