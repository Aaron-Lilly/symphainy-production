#!/usr/bin/env python3
"""
Direct Security Guard Service Test

Test the Security Guard micro-modules directly without importing the main service.
This test verifies that the micro-modules work with real business logic.
"""
...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'backend', 'smart_city', 'services', 'security_guard', 'micro_modules'))

from authentication import AuthenticationModule
from authorization import AuthorizationModule
from session_management import SessionManagementModule
from audit_logging import AuditLoggingModule

from config.environment_loader import EnvironmentLoader


async def test_micro_modules_direct():
    """Test micro-modules directly."""
    print("🧪 Testing Micro-Modules Directly")
    print("=" * 60)
    ...
    try:
        ...
        print(f"   Message: {permission_result.get('message', 'No message')}")
...
async def main():
    """Main test function."""
    print("🚀 Starting Direct Security Guard Service Tests")
    print("=" * 60)
    
    # Test micro-modules
    micro_test_success = await test_micro_modules_direct()
    ...
    if micro_test_success and business_test_success:
        ...
        print("✅ Real password hashing, validation, and authentication working")
        print("✅ Real authorization and permission checking working")
        print("✅ Real session management working")
        print("✅ Real audit logging working")
        return True
    else:
        print("\n❌ SOME TESTS FAILED!")
