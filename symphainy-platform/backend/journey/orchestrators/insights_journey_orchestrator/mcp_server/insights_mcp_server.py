#!/usr/bin/env python3
"""
Insights Realm MCP Server - Unified Pattern (Phase 3.2.5)

Exposes Insights Journey Orchestrator SOA APIs as MCP Tools for agent consumption.
...
class InsightsMCPServer(MCPServerBase):
    ...
    Exposes Insights Journey Orchestrator SOA APIs as MCP Tools.
    ...
    def __init__(self, orchestrator, di_container):
        ...
        Args:
            orchestrator: InsightsJourneyOrchestrator instance
    ...
    async def initialize(self):
        ...
        """
        try:
            self.logger.info("🔧 Initializing Insights Realm MCP Server (unified pattern)...")
    ...
    def get_usage_guide(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "realm": "insights",
            "description": "Insights Realm MCP Server - exposes Insights Journey Orchestrator capabilities",
