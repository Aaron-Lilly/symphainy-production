#!/usr/bin/env python3
"""
Journey Manager Service - Utilities Module
...
class Utilities:
    """Utilities module for Journey Manager service."""
    ...
    def get_service_capabilities(self) -> Dict[str, Any]:
        """Get Journey Manager service capabilities."""
        return {
            ...
            "capabilities": {
                ...
                "experience_orchestration": True
            },
            "active_journeys": len(self.service.active_journeys),
