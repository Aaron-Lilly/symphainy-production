#!/usr/bin/env python3
"""
InsightsSpecialist Functionality Tests

Tests InsightsSpecialist core functionality.
"""
...
class TestInsightsSpecialistAgentFunctionality:
    """Test InsightsSpecialist functionality."""
    ...
    @pytest.fixture
    async def insights_specialist_agent(self, mock_di_container, mock_insights):
        ...
        agent = InsightsSpecialistAgent(
            ...
            agent_id="insights_specialist_agent",
            agent_name="InsightsSpecialist"
        )
    ...
    async def test_agent_initialization(self, insights_specialist_agent):
        """Test agent initialization."""
        assert insights_specialist_agent is not None
        assert hasattr(insights_specialist_agent, 'di_container')
    
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="Abstract agent class - needs proper implementation")
    async def test_agent_uses_tools(self, insights_specialist_agent, mock_user_context):
