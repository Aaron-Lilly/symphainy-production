...
Tests Configuration core functionality.
"""
...
class TestConfigurationServiceFunctionality:
    ...
    @pytest.fixture
    async def configuration_service(self, mock_di_container, mock_platform_gateway):
